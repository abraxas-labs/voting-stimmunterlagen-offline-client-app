...
public class Program
{
    ...
    private static CommandLineApplication BuildCommandLineApplication()
    {
        ...
        {
            FullName = "VotingCardTool ZipTool",
            Description = "Zip- or unzip files using certificates."
        };
        ...
        cla.OnExecute(() =>
        {
            LoggerInitializer.Initialize(arguments.LogLevel, true, arguments.LogFileName);
