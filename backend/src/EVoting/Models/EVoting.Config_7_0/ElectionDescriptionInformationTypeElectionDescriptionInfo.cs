...
namespace EVoting.Config_7_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ElectionDescriptionInformationTypeElectionDescriptionInfo", Namespace="http://www.evoting.ch/xmlns/config/7", AnonymousType=true)]
