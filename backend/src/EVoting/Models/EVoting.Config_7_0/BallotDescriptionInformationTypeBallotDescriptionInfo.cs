...
namespace EVoting.Config_7_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("BallotDescriptionInformationTypeBallotDescriptionInfo", Namespace="http://www.evoting.ch/xmlns/config/7", AnonymousType=true)]
