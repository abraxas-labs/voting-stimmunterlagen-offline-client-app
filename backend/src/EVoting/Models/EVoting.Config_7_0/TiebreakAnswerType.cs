...
namespace EVoting.Config_7_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("tiebreakAnswerType", Namespace="http://www.evoting.ch/xmlns/config/7")]
    ...
    public partial class TiebreakAnswerType
    {
        ...
        public ushort AnswerPosition { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.MinLengthAttribute(1)]
        [System.ComponentModel.DataAnnotations.MaxLengthAttribute(50)]
        [System.Xml.Serialization.XmlElementAttribute("standardQuestionReference", Order=2)]
        public string StandardQuestionReference { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TiebreakAnswerType" /> class.</para>
        /// </summary>
        public TiebreakAnswerType()
        {
