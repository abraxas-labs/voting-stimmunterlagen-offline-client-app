...
namespace EVoting.Config_7_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ListUnionBallotTextTypeListUnionBallotTextInfo", Namespace="http://www.evoting.ch/xmlns/config/7", AnonymousType=true)]
