...
namespace EVoting.Config_6_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ContestDescriptionInformationTypeContestDescriptionInfo", Namespace="http://www.evoting.ch/xmlns/config/6", AnonymousType=true)]
