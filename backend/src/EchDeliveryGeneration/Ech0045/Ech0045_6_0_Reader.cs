...
{
    public class Ech0045_6_0_Reader : IEch0045Reader
    {
        private readonly Ech0045Deserializer _deserializer;

        public Ech0045_6_0_Reader(Ech0045Deserializer deserializer)
        {
        ...
        private Voting.Lib.Ech.Ech0045_4_0.Models.SwissPersonExtension? GetExtension(object? extension)
        {
            if (extension == null)
            {
                return null;
