...
public class MajorityElectionMapper
{
    ...
    public void MapToEchElection(ElectionInformationType election, EVoting.Print_1_3.ElectionType electionTypeSource, EVoting.Config_6_0.ElectionInformationType config)
    {
        ...
        if (electionTypeSource.List != null)
        {
            candidates.AddRange(electionTypeSource.List
                .SelectMany(l => l.Candidate?.ToList() ?? new List<EVoting.Print_1_3.CandidateListType>())
                .Select(c => new EVoting.Print_1_3.CandidateType { CandidateIdentification = c.CandidateListIdentification, ChoiceReturnCode = c.ChoiceReturnCode }));
        }
    ...
    private ElectionInformationTypeCandidate MapToEchCandidate(
        EVoting.Print_1_3.CandidateType candidateType,
        EVoting.Print_1_3.ElectionType electionTypeSource,
        EVoting.Config_6_0.ElectionInformationType config,
    ...
    private ElectionInformationTypeWriteInCodes MapToEchWriteInCodes(int index, EVoting.Print_1_3.WriteInCandidateType writeInCandidate, bool multipleNumberOfMandates)
    {
