...
public class VoterMapper
{
    ...
    public VotingPersonType MapToEchVoter(EVoting.Config_6_0.VoterType voterType, EVoting.Config_6_0.AuthorizationType authorization, Ech0045VoterExtension? echVoter, string printingRef, string municipalityRef, string municipalityName)
    {
        ...
        var sexType = personInfo.Sex == EVoting.Config_6_0.PersonTypeSex.Item1 ? SexType.Item1 : SexType.Item2;
        ...
        {
            case EVoting.Config_6_0.VoterTypeType.Swissresident:
                ...
                break;
            case EVoting.Config_6_0.VoterTypeType.Swissabroad:
                ...
                break;
            case EVoting.Config_6_0.VoterTypeType.Foreigner:
    ...
    private PersonTypeAddressExtension GetAddressExtension(
        EVoting.Config_6_0.VoterType voterType,
        ...
        CountryConfiguration physicalAddressCountryConfig)
    {
        ...
        if (voterType.VoterTypeProperty == EVoting.Config_6_0.VoterTypeType.Swissabroad)
        {
        ...
        {
            EVoting.Config_6_0.MrMrsType.Item1 => "Frau",
            EVoting.Config_6_0.MrMrsType.Item2 => "Herr",
            EVoting.Config_6_0.MrMrsType.Item3 => "Fräulein",
            _ => string.Empty,
        };
