...
public class ElectionMapper
{
    ...
    public ElectionInformationType MapToEchElection(EVoting.Print_1_3.ElectionType electionTypeSource, EVoting.Config_6_0.ElectionInformationType config)
    {
        ...
        if (config.Election.TypeOfElection == EVoting.Config_6_0.ElectionTypeTypeOfElection.Item1)
        {
            _proportionalElectionMapper.MapToEchElection(election, electionTypeSource, config);
        }
        else if (config.Election.TypeOfElection == EVoting.Config_6_0.ElectionTypeTypeOfElection.Item2)
        {
