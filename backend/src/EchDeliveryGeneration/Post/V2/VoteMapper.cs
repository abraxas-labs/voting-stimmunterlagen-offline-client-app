...
{
    public VoteType MapToEchVote(EVoting.Print_2_0.VoteType voteTypeSource, EVoting.Config_7_0.VoteInformationType configInfo)
    {
    ...
    private VoteTypeBallot MapToEchBallot(List<EVoting.Print_2_0.QuestionType> questions, EVoting.Config_7_0.BallotType ballotTypeConfig)
    {
    ...
    private List<AnswerOptionType> MapToEchAnswers(EVoting.Print_2_0.QuestionType question, List<EVoting.Config_7_0.StandardAnswerType> answers)
    {
    ...
    private List<AnswerOptionType> MapToEchAnswers(EVoting.Print_2_0.QuestionType question, List<EVoting.Config_7_0.TiebreakAnswerType> answers)
    {
        var answerList = new List<AnswerOptionType>();
        foreach (var answerType in answers)
        {
