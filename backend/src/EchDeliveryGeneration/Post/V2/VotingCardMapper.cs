...
public class VotingCardMapper
{
    ...
    public VotingCardDataType MapToEchVotingCard(
        EVoting.Print_2_0.VotingCardType votingCardType,
        EVoting.Config_7_0.Configuration configuration,
    ...
    private void AddVotesAndElection(
        ...
        EVoting.Print_2_0.VotingCardType votingCardSource,
        EVoting.Config_7_0.Configuration configSource)
    {
        ...
        if (votingCardSource.Election != null)
        {
            foreach (var election in votingCardSource.Election)
            {
                ...
                config.Candidate ??= new List<EVoting.Config_7_0.CandidateType>();
                election.WriteInPosition ??= new List<EVoting.Print_2_0.WriteInPositionType>();
                election.Candidate ??= new List<EVoting.Print_2_0.CandidateType>();
